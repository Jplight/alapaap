        ...
        if (isset($_POST['btn_reset_pass'])) {
            ...
            if ($sql) {  
                ...
                try {
                    ...
                    $mail->Body    = "Hello User!<br><br>Your password has been changed succesfully!<br><br><br><i>THIS IS AN AUTOMATICALLY GENERATED MESSAGE, DO NOT REPLY TO THIS EMAIL..</i>";
                    $mail->send();       
