...
//             $link = "http://localhost/revision_alapaap/model/reset_pass.php?email=".$email_add."&token=".$token."&attempt=".$attempt;
//             $message = "Dear Customer<br>"
//             . "Please click the link below to reset your password.<br>"
//             . "You will be automatically redirected to a welcome page where you can then change your password in your account.<br><br>"            
//             . "<a href='$link'>Click Here!</a>"; 
...
//             // $response['message'] = 'Your request has been successfully sent!';  
//             $response['link'] = 'http://localhost/revision_alapaap/model/support_alapaap.php?email='.$email_add.'&token='.$token;
