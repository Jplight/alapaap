...
if (isset($_POST['app_disapproved'])) {
	...
	$subject = "Disapproved Form"; 
	$message = "Hi <b>".ucwords($fullname)."</b>,<br><br>".
	"<b>".ucwords($approver_name). "</b> has disapproved your request with control number <b>".$form_subject."/".$txt_control_number."</b><br><br>".
...
if (isset($_POST['approver_returned'])) {
	...
	$message = "Hi <b>".ucwords($fullname)."</b>,<br><br>".
	"<b>".ucwords($approver_name). "</b> has returned your request with control number <b>".$form_subject."/".$txt_control_number."</b><br><br>".
	"Thank you"."<br><br><br><i>This message is autogenerated. Please do not respond.</i>";
...
if (isset($_POST['btn_rejected'])) {
	...
	$comment_id = rand(100000,999999);
	if ($_POST['form_type'] == 1 || $_POST['form_type'] == '1-1' || $_POST['form_type'] == '1-2' || $_POST['form_type'] == '1-3') {
		$sql = mysqli_query($conn,"UPDATE tbl_hci set status = '$status', revised = NULL, num_revised = NULL, reciever_id = NULL, reciever = NULL, rec_status = NULL, rec_date = NULL, performer_id = NULL, performer = NULL, perf_status = NULL, perform_date = NULL, verifier_id = NULL, verifier = NULL, ver_status = NULL, ver_date = NULL where control_number = '$txt_control_number' ");
		if (!empty($comments)) {
	...
	if ($_POST['form_type'] == 3 || $_POST['form_type'] == '3-1' || $_POST['form_type'] == '3-2' ) {
		$sql = mysqli_query($conn,"UPDATE tbl_cps set status = '$status', revised = NULL, num_revised = NULL, reciever_id = NULL, reciever = NULL, rec_status = NULL, rec_date = NULL, performer_id = NULL, performer = NULL, perf_status = NULL, perform_date = NULL, verifier_id = NULL, verifier = NULL, ver_status = NULL, ver_date = NULL where control_number = '$txt_control_number' ");
		if (!empty($comments)) {
			$sql_remarks = mysqli_query($conn,"INSERT INTO `tbl_remarks`(`form_type`, `control_number`, `comment_id`,`uid`, `fullname`, `comments`, `role`,`remarks_date`) VALUES ('$form_type','$txt_control_number','$comment_id','$uid','$fullname','$comments', '$role', NOW()) ");
		}	
		$form_subject = "CPS";	
	...
	$subject = "eBiz Managed Services Control Number: ".$form_subject."/".$txt_control_number;
	$message = "Hi <b>Receiver</b>,<br><br>".
	"<b>".ucwords($fullname). "</b> has returned <b>".$form_subject."</b> request with control number <b>".$form_subject."/".$txt_control_number."</b><br><br>".
	"Thank you"."<br><br><br><i>This message is autogenerated. Please do not respond.</i>";
