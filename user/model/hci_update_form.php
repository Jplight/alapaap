...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_POST['btn_submit_hci_up'])) {
		...
		$sql = mysqli_query($conn,"INSERT INTO `tbl_hci` (`uid`, `control_number`, `hci_new_control_num`, `form_type`, `fullname`, `email_add`, `contact_no`, `department`, `location`, `cluster`, `hostname`, `vcpu`, `vcpu_comment`, `ram`, `ram_comment`, `os`, `os_comment`, `txt_os_descript`, `txt_define_parti`, `ip_add_vlan`, `ip_comment` , `txt_ip_vlan`, `vlan_comment`,`hci_users`, `txt_hci_users`, `vm_deployment`, `vm_deployment_comment`, `comm`, `comm_comment`,`status`, `date_requested`, `ex_requested_by`) VALUES ('$uid','$control_number', '$hci_new_control_num','$form_type','$fullname','$email_add','$contact_no','$hci_up_department','$hci_up_location','$hci_up_cluster','$hci_up_search_txt','$hci_up_req_vcpu','$hci_up_vcpu_comment','$hci_up_req_ram','$hci_up_ram_comment','$hci_up_req_os_new','$hci_up_os_comment', '$hci_up_req_desc', '$hci_up_req_parti', '$hci_up_req_ipadd', '$hci_up_ipadd_comment', '$hci_up_req_vlan', '$hci_up_vlan_comment', '$hci_up_req_users', '$hci_up_req_txt_hci_users', '$hci_up_req_vm_deployment', '$hci_up_req_vm_deployment_comment', '$hci_up_req_comm', '$hci_up_comm_comment','$status',NOW(), '$requested_by') ");
