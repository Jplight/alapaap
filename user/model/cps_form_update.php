...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_POST['btn_submit_cps_up'])) {
		...
		$sql = mysqli_query($conn,"INSERT INTO `tbl_cps`(`uid`,`control_number`, `cps_new_control_num`,`form_type`, `fullname`, `email_add`, `contact_no`, `system_name`, `hostname`, `pattern`, `instance_name`, `location`, `env_profile`, `ip_add`, `ip_group`, `vcpu_size`, `vcpu_filesystem`, `vcpu_remarks`, `ram_size`, `ram_filesystem`, `ram_remarks`, `ue_enroll_size`, `ue_filesystem`, `ue_remarks`, `status`, `date_requested`, `ex_requested_by`) VALUES ('$uid','$control_number', '$cps_new_control_num', '$form_type','$fullname','$email_add','$contact_no', '$cps_up_system_name','$cps_up_search_txt','$cps_up_pattern','$cps_up_instance_name','$cps_up_location','$cps_up_env_profile','$cps_up_ip_add','$cps_up_ip_group','$cps_up_vcpu_size_req','$cps_up_vcpu_filesystem','$cps_up_vcpu_remarks','$cps_up_ram_size_req','$cps_up_ram_filesystem','$cps_up_ram_remarks','$cps_up_ue_enroll_size_req','$cps_up_ue_filesystem','$cps_up_ue_remarks','$status', NOW(), '$requested_by' )");
	...
	if (isset($_POST['btn_submit_draft_cps_up'])) {
		...
		$sql = mysqli_query($conn,"UPDATE `tbl_cps` SET `form_type`='$form_type', `system_name`='$cps_up_system_name',`hostname`='$cps_up_search_txt',`pattern`='$cps_up_pattern',`instance_name`='$cps_up_instance_name',`location`='$cps_up_location',`env_profile`='$cps_up_env_profile',`ip_add`='$cps_up_ip_add',`ip_group`='$cps_up_ip_group',`vcpu_size`='$cps_up_vcpu_size_req',`vcpu_filesystem`='$cps_up_vcpu_filesystem',`vcpu_remarks`='$cps_up_vcpu_remarks',`ram_size`='$cps_up_ram_size_req',`ram_filesystem`='$cps_up_ram_filesystem',`ram_remarks`='$cps_up_ram_remarks',`ue_enroll_size`='$cps_up_ue_enroll_size_req',`ue_filesystem`='$cps_up_ue_filesystem',`ue_remarks`='$cps_up_ue_remarks',`status`='$status',`date_requested`= NOW(), `ex_requested_by` = '$requested_by' WHERE control_number = '$txt_control_number' ");
	...
	if (isset($_POST['btn_resubmit_cps_up'])) {
		...
		$txt_control_number = $_POST['txt_control_number'];
		$revised = 0;
		$sql = mysqli_query($conn,"UPDATE `tbl_cps` SET `form_type`='$form_type', `system_name`='$cps_up_system_name',`hostname`='$cps_up_search_txt',`pattern`='$cps_up_pattern',`instance_name`='$cps_up_instance_name',`location`='$cps_up_location',`env_profile`='$cps_up_env_profile',`ip_add`='$cps_up_ip_add',`ip_group`='$cps_up_ip_group',`vcpu_size`='$cps_up_vcpu_size_req',`vcpu_filesystem`='$cps_up_vcpu_filesystem',`vcpu_remarks`='$cps_up_vcpu_remarks',`ram_size`='$cps_up_ram_size_req',`ram_filesystem`='$cps_up_ram_filesystem',`ram_remarks`='$cps_up_ram_remarks',`ue_enroll_size`='$cps_up_ue_enroll_size_req',`ue_filesystem`='$cps_up_ue_filesystem',`ue_remarks`='$cps_up_ue_remarks',`status`='$status', `revised` = '$revised', `date_requested` = NOW(), `ex_requested_by` = '$requested_by' ,approver_id = NULL, approver = NULL, app_status = NULL, appr_date = NULL, reciever_id = NULL, reciever = NULL, rec_status = NULL, rec_date = NULL, performer_id = NULL, performer = NULL, perf_status = NULL, perform_date = NULL WHERE control_number = '$txt_control_number' ");
