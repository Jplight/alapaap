                                                            ...
                                                            if ($my_role == 1) {
                                                                ...
                                                                while ($rows_hci = mysqli_fetch_array($hci_query)):                        
                                                                    ...
                                                                    if ($rows_hci['form_type'] == '1-1') {
                                                                        ...
                                                                        $print = '<a class="btn btn-outline-primary btn-sm shadow-sm" href="inc/print/print_hci_clone.php?control_number='.$rows_hci["control_number"].'" target="_blank"  ><i class="fa-fw fas fa-print me-1"></i>Print</a>';
                                                                        echo '<td class="d-flex gap-2"><a class="btn btn-outline-primary btn-sm shadow-sm" href="#view_hci_clone'.$rows_hci["control_number"].'" data-bs-toggle="modal" ><i class="fa-fw fas fa-eye me-1"></i>View</a>'.$print.'</td>';
                                                                        echo '<td>';
