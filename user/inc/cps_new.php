        ...
        <div class="modal-dialog modal-xl modal-fullscreen-xl-down" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-end">       
                    ...
                    <div>
                        <button class="btn btn-secondary me-2" type="submit" name="btn_update_cps" ><i class="fa-fw fas fa-refresh me-1"></i>Update</button>
                        <button class="btn btn-primary" type="submit" name="btn_submit_draft_cps" ><i class="fa-fw fas fa-paper-plane me-1"></i>Resubmit</button>
                    </div>
                    <?php endif; ?>
                    <?php if ($my_role == 1 && $revised == 1): ?>
                    <div>
                        <button class="btn btn-primary" type="submit" name="btn_resubmit_cps" ><i class="fa-fw fas fa-paper-plane me-1"></i>Resubmit</button>
                    </div>    
                    <?php endif; ?>
                    ...
                    <div>
                        <button class="btn btn-danger" type="submit" name="btn_cancel_cps" ><i class="fa-fw fas fa-times me-1"></i>Cancel</button>
                    </div>    
                    <?php endif; ?>
                ...
                <?php if (empty($control_number)): ?>
                    <div class="modal-footer d-flex justify-content-end">
                        <div>
                            <button class="btn btn-secondary" type="submit" name="btn_save_cps" ><i class="fa-fw fas fa-file me-1"></i>Draft</button>
                            <button class="btn btn-primary" type="submit" name="btn_submit_cps" ><i class="fa-fw fas fa-paper-plane me-1"></i>Submit</button>                                
                        </div>
                    </div>
                <?php endif; ?>
            </div>
