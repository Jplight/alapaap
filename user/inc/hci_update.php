        ...
        <div class="modal-dialog modal-xl modal-fullscreen-xl-down" role="document">
            <div class="modal-content">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-top">
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <input class="form-control text-dark" type="text" name="hci_up_req_desc" id="hci_up_req_desc" value="<?php echo empty($hci_up_req_desc) ? '' : $hci_up_req_desc; ?>" placeholder="Specify OS Environment (with or w/o GUI:)" onkeypress="return /[A-Z0-9 ]/i.test(event.key)" />
                                        </td>
                                         <td>
                ...
                <?php if (empty($control_number)): ?>
                    <div class="modal-footer d-flex justify-content-end">
                        <div>
                            <button class="btn btn-secondary" type="submit" id="btn_save_hci_up" name="btn_save_hci_up" disabled ><i class="fa-fw fas fa-file me-1" ></i>Draft</button>
                            <button class="btn btn-primary" type="submit"  id="btn_submit_hci_up" name="btn_submit_hci_up" disabled ><i class="fa-fw fas fa-paper-plane me-1"></i>Submit</button>      
                        </div>
                    </div>
                <?php endif; ?>
            </div>
