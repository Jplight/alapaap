...
?>
    ...
    <form class="text-dark" method="post" id="frm_baas_1" name="frm_baas_1"> 
        <div class="modal" role="dialog" tabindex="-1" id="view_baas<?php echo empty($control_number) ? '' : $control_number; ?>" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-fullscreen-lg-down" role="document">
                <div class="modal-content">                              
                    ...
                    <div class="modal-body user-select-none">
                        <div class="row g-0 d-flex flex-column-reverse flex-lg-row w-100 gap-3 gap-lg-0">
                            <div class="col-md-12 col-lg-5 col-xl-4 offset-lg-1 offset-xl-1">
                                ...
                                <input type="hidden" class="form-control" name="email_add"  value="<?php echo empty($email) ? '' : $email; ?>" readonly >
                            </div>
                        </div>                       
                        ...
                        <div class="row d-flex justify-content-center g-0 mb-2">
                            ...
                            <div class="col-lg-7">
                                <input  type="email" class="form-control"  name="form_owner_mail" value="<?php echo empty($email_add) ? '' : $email_add; ?>" readonly>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center g-0 mb-2">
                            <div class="col-lg-3">
                    ...
                    <div class="modal-footer d-flex justify-content-end">
                        ...
                        <div>
                            <button class="btn btn-danger launchModal" type="button" id="btn_cancel_csrf" data-bs-toggle="modal" data-bs-target="#myModal2<?php echo $formt; echo empty($control_number) ? '' : $control_number; ?>" value="Do you want to cancel this request?"><i class="fa-fw fas fa-times me-1"></i>Cancel</button>
