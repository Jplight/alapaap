                                    ...
                                    <tbody class="text-dark">
                                        ...
                                        <tr>
                                            <td class="align-top" colspan="3">
                                                <input class="form-control form-control-sm text-dark" type="text" id="hostname" name="hostname" value="<?php echo empty($hostname) ? '' : $hostname; ?>" placeholder="Input your Host Name" required onkeypress="return /[0-9A-Z.-_]/i.test(event.key)" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control form-control-sm text-dark volume_id1" type="text" name='others_1[]' value="<?=$rows['others_1']?>" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" >
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark uname1" type="text" name='others_2[]' value="<?=$rows['others_2']?>" placeholder="Optional">
                                            </td>
                                        </tr>
                                        <?php 
                                                endwhile; 
                                        ...
                                        <tr id='straas_addr1'>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end position-relative">
                                                    ...
                                                    <input class="form-control form-control-sm text-dark volume_id1" type="text" name='others_1[]' required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" >
                                            ...
                                            <td>
                                                <input class="form-control form-control-sm text-dark uname1" type="text" name='others_2[]' placeholder="Optional">
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                        <!-- View data in DISK GB -->
