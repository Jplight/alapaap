	...
	const data = [
		{
			...
			buttons: [
				...
				{ name: "#btn_reciever", msg: "Approve this form?" },
				{ name: "#btn_performer", msg: "Approve this form?" },
				{ name: "#btn_confirmer", msg: "Approve this form?" },
				{ name: "#btn_verifier", msg: "Approve this form?" },
			],
		},
		{
			form: "form_new",
