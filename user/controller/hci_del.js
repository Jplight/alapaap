    ...
    $(document).ready(function(){
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, value) {
                        if (value.hostname.search(expression) != -1 ) {
                            $('#hci_del_search_result').append('<li class="list-group-item list-group-item-action" id="' + value.hostname + '" style="cursor: pointer;"><span class="font-weight-bold sp_destination" id="' + value.hostname + '">' + value.hostname + '</span></li>');
                        }
                    });
                }
            });
        ...
        $('#hci_del_search_txt').keyup(function () {
